...
public class Maze {
	...
	public List<MazeNode> dfs(int startRow, int startCol, int endRow, int endCol) {
		...
		Boolean found = dfsearch(start, goal, parentMap);
		...
		return dfsReconstruction(start, goal, parentMap);
	}
	
	private boolean dfsearch(MazeNode start, MazeNode goal, HashMap<MazeNode, MazeNode> parentMap) {
	...
	private LinkedList<MazeNode> dfsReconstruction(MazeNode start, MazeNode goal, HashMap<MazeNode, MazeNode> parentMap){
